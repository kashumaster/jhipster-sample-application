...
import { MyFirstApplicationSharedModule } from 'app/shared';
import { MyFirstApplicationCoreModule } from 'app/core';
...
import { MyFirstApplicationAccountModule } from './account/account.module';
...
@NgModule({
    imports: [
        ...
        MyFirstApplicationAccountModule,
